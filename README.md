...
<pre>Note:This is project uses the Universal Render Pipeline (URP)</pre>
...
<pre>Note: We recomend cloning via command line and make sure you have git lfs intstalled in your computer. Because we are not sure that you will be able to clone everything(shaders, meshes etc). If you don't have git lfs installed you can do it from [here](https://git-lfs.github.com/)</pre>
