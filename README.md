...
that you will be able to clone everything(shaders, meshes etc).If you don't have git lfs installed you can do it from <a href="https://git-lfs.github.com/">here</a>
</pre>
